...
class DINOv2Encoder(nn.Module):
    ...
    def __init__(self, backbone: str, intermediate_layers: Union[int, List[int]], dim_out: int, ignore_layers: Union[str, List[str]]=[], in_chans: int=3, strict: bool=True, depth_emb_mode='',img_depth_fuse_mode='', mask_ratio=0.6, img_mask_ratio=0.0, **deprecated_kwargs):
        ...
        self.backbone = self.hub_loader(pretrained=False, in_chans=in_chans, 
                                        depth_emb_mode=depth_emb_mode, img_depth_fuse_mode=img_depth_fuse_mode, 
                                        mask_ratio=mask_ratio, img_mask_ratio=img_mask_ratio)
    ...
    def forward(self, image: torch.Tensor, depth: torch.Tensor, token_rows: Union[int, torch.LongTensor], token_cols: Union[int, torch.LongTensor], return_class_token: bool = False, remap_depth_in: str='linear'):
        ...
        input_14 = torch.cat([image_14, depth_14, dmask_14.float()], dim=1)
