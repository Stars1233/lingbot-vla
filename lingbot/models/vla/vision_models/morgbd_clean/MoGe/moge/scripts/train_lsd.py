...
@click.option('--pretrain', type=str, default=None, help='Path to the pretrained backbone to load')
def main(
    config_path: str,
    workspace: str,
    checkpoint_path: str,
    ...
    if pretrain is not None:
        ...
        model.backbone.load_state_dict(pretrain_ckpt)
