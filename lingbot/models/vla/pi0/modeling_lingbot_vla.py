...
from lingbot.models.vla.vision_models.align_heads.depth_head import DepthHead, TaskTokenDepthHead
...
class LingbotVlaPolicy(PreTrainedPolicy):
    ...
    def __init__(
        self,
        config: PI0Config,
        tokenizer_path: str = "/robby/share/MM/checkpoints/huggingface/Qwen2.5-VL-3B-Instruct/",
    ):
        """
        Args:
